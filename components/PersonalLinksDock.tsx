  ...
  resume: (props: IconProps) => (
    ...
    >
      <path
        ...
        style={{ outline: "none" }}
      />
      <path d="M14 2v5a1 1 0 0 0 1 1h5" style={{ outline: "none" }} />
      <path d="M10 9H8" style={{ outline: "none" }} />
      <path d="M16 13H8" style={{ outline: "none" }} />
      <path d="M16 17H8" style={{ outline: "none" }} />
    </svg>
  ),
...
export function PersonalLinksDock() {
  return (
